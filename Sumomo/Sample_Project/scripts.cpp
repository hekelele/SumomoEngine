...
void makeGameObjects()
{
	...
	ball_01 = BallFactry::makeBall(50,0.8f,Vector3(4, 3, 0), Vector3(400, 150, 0));
	ball_02 = BallFactry::makeBall(50,0.8f,Vector3(4, -3, 0), Vector3(400, 450, 0));
	ball_03 = BallFactry::makeBall(10, 1, Vector3(20, 30, 0), Vector3(100, 50, 0));
	ball_04 = BallFactry::makeBall(100, 0.9f, Vector3(-1, -1.5f, 0), Vector3(200, 300, 0));
